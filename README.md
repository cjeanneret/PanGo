...
<p align="center">
  <img src="internal/web/static/img/logo-256.png" alt="PanGo logo" width="128" height="128">
</p>
...
The project logo was generated by **Perplexity** (prompt and image creation). See [internal/web/static/img/LOGO.md](internal/web/static/img/LOGO.md) for the full prompt and attribution.
